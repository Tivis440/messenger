...
Клиент проверяет TLS-сертификат по заранее встроенному SHA-256 fingerprint текущего VPS-сервера.

Если сервер был переустановлен или сертификат осознанно заменен, нужно обновить fingerprint в клиенте и пересобрать приложение.
